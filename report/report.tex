...
This work investigates the properties of the Ethereum network. The focus in this research lies on the execution of the smart contracts that occur in this network. This analysis involves the use of various graph analysis tools to produce insights about this network. 
